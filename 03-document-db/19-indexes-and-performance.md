...
[Lesson 2.15](../02-sql/18-indexes-and-performance.md):
...
Just like [Lesson 2.15](../02-sql/18-indexes-and-performance.md)'s honest
...
Identical rule to [Lesson 2.15](../02-sql/18-indexes-and-performance.md)'s
...
Same list as [Lesson 2.15](../02-sql/18-indexes-and-performance.md): small
...
| SQL ([Lesson 2.15](../02-sql/18-indexes-and-performance.md)) | MongoDB |
|---|---|
