← [3.7 Types of MongoDB Operations](07-types-of-mongodb-operations.md)

# 3.8 Data Types in MongoDB (BSON)
...
If you don't provide `_id` yourself (like [3.6](06-your-first-database-apple-example.md)
...
[3.13](13-embedding-vs-referencing.md) covers exactly when this is a
...
---
← [3.7 Types of MongoDB Operations](07-types-of-mongodb-operations.md) | Next: [3.9 Query Operators →](09-query-operators.md)
