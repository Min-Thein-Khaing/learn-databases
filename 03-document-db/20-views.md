...
updatable — [Lesson 2.16](../02-sql/19-views.md), Step 5), a MongoDB view is
...
Same tradeoff as [Lesson 2.16](../02-sql/19-views.md)'s materialized view —
faster to read, goes stale until you re-run the aggregation.

## Recap

| SQL ([Lesson 2.16](../02-sql/19-views.md)) | MongoDB |
|---|---|
