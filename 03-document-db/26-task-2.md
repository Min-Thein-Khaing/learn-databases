...
# Task 2: Write the Queries — Lessons 3.16–3.24

2 practice tasks for each remaining Part 2 lesson — from
[3.16 Aggregation Pipelines](16-aggregation-pipelines.md) through
[3.23 Capstone](23-capstone.md), plus a closing pair tied to
[3.24 Document Databases Conclusion](24-conclusion.md) — 18 tasks total. Write the
...
[3.23 Capstone, Step 7](23-capstone.md)) to do it in a single round trip.
</details>
...
[3.16, Step 1](16-aggregation-pipelines.md) showed a `$group` followed by a
...
`SAVEPOINT`** equivalent ([3.18, Step 6](18-transactions.md)). To "keep the
...
[3.21](21-create-collections-examples.md) — both things SQL has no
...
`$facet` the way [3.23, Step 7](23-capstone.md) combined a per-product list
...
Using [3.23](23-capstone.md)'s review data (iPhone 17 Pro 5.00, MacBook Air
...
[M's bonus step](15-lookup-joins.md), and `$facet`.
...
Using [3.20 Views](20-views.md)'s totals (Alice 3396.00, Bob 2788.20, Carla
...
---
← [Task 1](25-task-1.md) | Next: [Coffee-Shop Example →](28-coffeeshop-diagram.md)
